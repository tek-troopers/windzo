<template>
    ...
    <div class="accordion h-auto p-3">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                           class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Accordion</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid lg:grid-cols-1 grid-col-1 gap-4 mt-5">
            <!-- default alert  -->
            <div class="card col-span-1 grid grid-cols-1 gap-5 bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700">
                <div class="accordion-packed">
                    <h2 class="font-semibold dark:text-gray-200">Accordion Default</h2>
                    <div class="wrapper mt-5">
                        <!-- copy this component  -->
                        <app-accordion>
                            <template #title> Click me to open</template>
                            <template #content>
                                <p>
            ...
            <div class="card row-span-1 grid grid-cols-1 gap-5 bg-white dark:bg-gray-800 w-full rounded-md p-5 border dark:border-gray-700">
                <div class="accordion-packed">
